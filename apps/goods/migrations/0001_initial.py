# Generated by Django 2.1.7 on 2019-03-06 14:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_sn', models.CharField(default='', help_text='商品唯一货号', max_length=20, verbose_name='商品唯一货号')),
                ('good_brief', models.CharField(default='', help_text='商品简介', max_length=500, verbose_name='商品简介')),
                ...
                ('shop_num', models.IntegerField(default=0, verbose_name='本店价格')),
                ('shop_free', models.BooleanField(default=False, verbose_name='是否承担邮费')),
                ('is_new', models.BooleanField(default=False, verbose_name='是否新品')),
                ('good_desc', DjangoUeditor.models.UEditorField(default='', help_text='品牌描述', verbose_name='品牌描述')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', help_text='类别', max_length=20, verbose_name='类别名')),
                ('code', models.CharField(default='', help_text='类别code', max_length=10, verbose_name='类别code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iamge', models.ImageField(blank=True, null=True, upload_to='', verbose_name='图片')),
                ('image_url', models.CharField(blank=True, max_length=300, null=True, verbose_name='图片路径')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
